      ...
      <nav class="teal">
        ...
        <div class="nav-wrapper">
          ...
          <ul class="right hide-on-med-and-down">
            <li><a href="StudentDetailList">Back</a></li>
            <li>
              <a
                a
        ...
        <div class="card-panel inner2 z-depth-4 grey lighten-3">
                ...
                <table class="" style="">
                    ...
                    <tr style="font-size:15px;">
                            ...
                            <td><input type="text" id="sec" name="sec" value="${requestScope.department.sec}"></td>
                     ...
                     <tr style="font-size:15px;">
                                ...
                                <td colspan="2"><input type="text" id="mobile" name="mobile" value="${requestScope.student.phoneno}"></td>
                         ...
                         <tr style="font-size:15px;">
                                ...
                                <td colspan="2"><input type="text" id="dob" name="dob" value="${requestScope.student.dob}"></td>

                         </tr>  
                    <tr style="font-size:15px;">
                                <td class="black-text"><i class="material-icons prefix black-text">perm_identity</i>&nbsp; &nbsp;<b>Father's Name:</b></td>
                                <td colspan="3"><input type="text" id="Fname" name="Fname" value="${requestScope.student.fathername}"></td>
                                <td class="black-text"><i class="material-icons prefix black-text">phone</i>&nbsp; &nbsp;<b>Father's No:</b></td>
                                <td><input type="text" id="Fno" name="Fno" value="${requestScope.student.fatherphoneno}"></td>
                        </tr>
                        <tr style="font-size:15px;">
                       ...
                       <tr style="font-size:15px;">
                            ...
                            <td colspan="2"><input type="text" id="marks1" name="marks1" value="${requestScope.student.marks10}"></td>
                            <td class="black-text"><b>12th Marks:</b></td>
                            <td colspan="2"><input type="text" id="marks2" name="marks2" value="${requestScope.student.marks12}"></td>
                    </tr>
                </table> 
        </div>  
        </div>
