    ...
    <div class="main grey lighten-1">
      ...
      <div class="inner card-panel  hover z-depth-4">
            <div class="carousel carousel-slider center z-depth-2" >
                  ...
                  <h4 class="center z-depth-3 amber brown-text">STUDENT ACCOUNT</h4> 
                 <div class="container" style="padding-top: 30px;"> <div class="row"> <div class="col l6"><div class="card medium z-depth-5" style="border-radius:2%">
                        ...
                        <div class="card-content">
                          ...
                          <p><a href="#">STUDENT ${sessionScope.DepartmentAdmin.getDept_name()} </a></p>
                        ...
                        <div class="card-reveal teal">
                          ...
                          <tr>
                          <td><b>Name:</b></td>
                          <td>${sessionScope.Student.getS_name()}</td>
                          </tr>
                          <tr>
                          <td><b>Enroll No:</b></td>
                          <td>${sessionScope.Student.getEnrollno()}</td>
                          </tr>
                          ...
                          <td>${sessionScope.Student.getEmail()}</td>
                           ...
                           <tr>
                          <td><b>Mobile No:</b></td>
                          <td>${sessionScope.Student.getPhoneno()}</td>
                          </tr>
                          
                          <tr>
                          <td><b>Department:</b></td>
                          <td>${sessionScope.DepartmentAdmin.getDept_name()}</td>
                          </tr>
                         <tr>
                         <tr>
                          <td><b>Sec:</b></td>
                          <td>${sessionScope.DepartmentAdmin.getSec()}</td>
                          </tr>
                         <tr>
                         <tr>
                          <td><b>Sem:</b></td>
                          <td>${sessionScope.DepartmentAdmin.getSem()}</td>
                          </tr>
                         <tr>
                          <td><b>Category:</b></td>
                          <td>${sessionScope.Student.getCategory()}</td>
                          </tr>
                          <tr>
                          <td><b>DOB:</b></td>
                          <td>${sessionScope.Student.getDob()}</td>
                          </tr>
