...
<html>
  ...
  <body>
    ...
    <div class="main grey lighten-1">
        <div class="inner card-panel  hover z-depth-4">
                ...
                <form name="AdminStudentdetailList" id="AdminStudentdetailList" action="AdminStudentDetailList" method="post">
                <div class="row">
 ...
 <!-----------------------------------------form khtm-------------------------------------------------------->
 <h4 class="center z-depth-3 amber white-text">STUDENT DETAILS</h4>
 <div class="divider teal"></div>  
 <!----------------------------------------------Table----------------------------------------------------------------->                            
 <div class="row">
        <div class="col s2 z-depth-2  black-text grid" style=""><i class=" material-icons teal-text">perm_contact_calendar</i><span> &nbsp; &nbsp; &nbsp;<b>${sessionScope.dept1}</b></span></div>
        <div class="col s2 z-depth-2 grid"><i class=" material-icons teal-text">offline_pin</i><span> &nbsp; &nbsp; &nbsp;<B>${sessionScope.sec1}</B></span></div>
        <div class="col s2 z-depth-2 grid"><i class=" material-icons teal-text">offline_pin</i><span> &nbsp; &nbsp; &nbsp;<B>${sessionScope.sem1}</B></span></div> </div>          
        ...
        <table class="bordered highlight centered responsive-table " style=>
                <thead class="  teal-text">
                    ...
                    <td>${stud.phoneno}</td>
                    <td>${stud.dob}</td>
                    <td><form name="detail" id="detail" action="AdminStudentDetail" method="post">
