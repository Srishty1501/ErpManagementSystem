              ...
              <ul class="collapsible collapsible-accordion">
                <li class="bold">
                  ...
                  <div class="collapsible-body">
                    <ul>
                      <li><a href="#">View Total Attendance</a></li>
    ...
    <div class="main grey lighten-1">
      ...
      <div class="inner card-panel  hover">
          ...
          <h3 class="center-align  " style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif">VIEW ATTENDANCE</h3>
           <form action="StudentTotalAttendance" method="post">
          <div class="row">
                    <div class="col l6 offset-l3 m9 offset-m1">
                      <div class="card-panel teal">
                                ...
                                <div class="row center">
                                  <button class="btn white teal-text waves-effect waves-light" type="submit" name="action" >Submit
                  ...
                  <div class="row grid-parent">
                        ...
                        <div class="col s3 z-depth-2 grid"><i class=" material-icons teal-text">date_range</i><span> &nbsp; &nbsp; &nbsp;<B>From:14/04/2019 </B></span></div>
                        <div class="col s3 z-depth-2 grid"><i class=" material-icons teal-text">date_range</i><span> &nbsp; &nbsp; &nbsp;<B>To:25/04/2019 </B></span></div>
                    </div>
...
<c:forEach items="${requestScope.sublist}" var="sublist" varStatus="counter">
<tr><td>${counter.count}</td>
<td>${sublist.sub_name}</td>
<td>${sublist.totatten}</td>
</tr>
</c:forEach>
<tr>
