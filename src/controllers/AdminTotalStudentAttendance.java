...
/**
 * Servlet implementation class AdminTotalStudentAttendance
 */
@WebServlet("/AdminTotalStudentAttendance")
public class AdminTotalStudentAttendance extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminTotalStudentAttendance() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("AdminViewAllStudentAttendance.jsp");
